...
// HOLIDAY BLOG / FAQ STYLE PAGE
const TatillerBlog = ({ navigate }: { navigate: (p: string) => void }) => {
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (currentPage === 'tatiller') title = 'Tatiller Blogu: Net Cevaplar - Resmi Günler';
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'tatiller': return <TatillerBlog navigate={navigate} />;
